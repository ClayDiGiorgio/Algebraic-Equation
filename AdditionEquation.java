...
/**
 * Write a description of class AdditionEquation here.
 * 
 * @author (your name) 
...
public class AdditionEquation extends Equation{
    ...
    public AdditionEquation(Equation e1, Equation e2){
        this.e1 = e1;
        this.e2 = e2;
    }
    ...
    public Equation solve(SolutionSet s){
        return new AdditionEquation(e1.solve(s), e2.solve(s)).simplify();
    }
    ...
    public Equation getDerivative(){
        return new AdditionEquation(e1.getDerivative(), e2.getDerivative());
    }
    
    public Equation getPartialDerivative(String respect){
        return new AdditionEquation(e1.getPartialDerivative(respect), e2.getPartialDerivative(respect));
    }
    ...
    public Equation simplify(){
        if (e1.isConstant && e2.isConstant) {
            ...
            return new PowerEquation(new ConstantEquation(2), new VariableEquation());
        }
        
        return new AdditionEquation(e1.simplify(), e2.simplify());
    }
